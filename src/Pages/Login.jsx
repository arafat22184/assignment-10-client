...
//           <div>
//             <label className={`block mb-1 ${labelColor}`}>Password</label>
//             <input
//               type="password"
//               name="password"
//               required
...
//           <button
//             type="submit"
//             className={`w-full py-2 ${buttonBg} font-semibold rounded-md transition duration-300 text-white`}
//           >
//             Login
//           </button>
//         </form>
    ...
    <div className="flex items-center justify-center px-4 my-8">
      ...
      >
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            <label
              className={`block mb-1 flex items-center gap-2 ${labelColor}`}
            >
              <MdEmail /> Email
            </label>
            <input
          ...
          <button
            type="submit"
            className={`w-full py-2 ${buttonBg} font-semibold rounded-md transition duration-300 text-white flex items-center justify-center gap-2`}
          >
            <MdLogin /> Login
          </button>
        </form>
